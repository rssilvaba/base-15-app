...
export class ButtonComponent extends ClassDirective implements OnInit {
  constructor() {
    super(`Button ${buttonDefaultStyles} ${buttonActiveStyles}  ${buttonFocusStyles}`);
  }

  ngOnInit() {
    this.class = `${this.class} ${buttonSizeVariantStyles[this.size]} ${buttonColorVariantStyles[this.variant]} ${
...
export class ButtonLinkComponent extends ClassDirective {
  constructor() {
    super(`Button ${buttonDefaultStyles} ${buttonActiveStyles}  ${buttonFocusStyles}`);
  }
